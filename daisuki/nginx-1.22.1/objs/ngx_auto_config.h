#define NGX_CONFIGURE " --prefix=/usr/local/nginx --sbin-path=/usr/local/nginx/sbin/nginx --conf-path=/usr/local/nginx/conf/nginx.conf --pid-path=/usr/local/nginx/secure/nginx.pid --lock-path=/usr/local/nginx/secure/nginx.lock --error-log-path=/usr/local/nginx/logs/error.log --http-log-path=/usr/local/nginx/logs/access.log --with-zlib=/daisuki/zlib-1.2.13 --with-pcre=/daisuki/pcre-8.45 --with-openssl=/daisuki/openssl-1.1.1s --with-http_ssl_module --with-debug --user=nginx --group=nginx"
...
#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 8.5.0 20210514 (Red Hat 8.5.0-16) (GCC) "
#endif
...
#ifndef NGX_PID_PATH
#define NGX_PID_PATH  "/usr/local/nginx/secure/nginx.pid"
#endif


#ifndef NGX_LOCK_PATH
#define NGX_LOCK_PATH  "/usr/local/nginx/secure/nginx.lock"
#endif
